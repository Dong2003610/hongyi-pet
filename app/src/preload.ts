...
const api: PetAPI = {
  ...
  reminders: {
    ...
    snooze: (id, minutes) => ipcRenderer.invoke('reminders:snooze', id, minutes) as Promise<Reminder | undefined>,
  },
  chat: {
  ...
  pomodoro: {
    ...
    status: () => ipcRenderer.invoke('pomodoro:status') as Promise<{ phase: string; endsAt: number }>,
  },
  interactions: {
  ...
  window: {
    ...
    beginResize: () => ipcRenderer.invoke('window:resize-begin') as Promise<void>,
    updateResize: () => ipcRenderer.invoke('window:resize-update') as Promise<void>,
    endResize: () => ipcRenderer.invoke('window:resize-end') as Promise<void>,
  ...
  events: {
    ...
    onDisplayName: (listener) => subscribe<string>('display-name', listener),
    onPlaySound: (listener) => subscribe<string>('sound:play', listener),
    onPomodoro: (listener) => subscribe<{ phase: string; endsAt: number }>('pomodoro:status', listener),
  },
};
